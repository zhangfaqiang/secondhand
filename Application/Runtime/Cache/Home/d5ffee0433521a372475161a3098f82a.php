...
<div class="grzxbj">
    <div class="selfinfo center">
        ...
        <div class="rtcont fr">
            ...
            <?php if(is_array($payinfo)): foreach($payinfo as $key=>$p): ?><div class="ddxq">

                    <div class="ddbh fl">订单号:<?php echo ($p['user_order']); ?></div>
                    <div class="ztxx fr">
                        <ul>
                            <li><?php echo ($p['good_statename']); ?></li>
                            <li>￥<?php echo ($p['user_total']); ?></li>
                            <li><?php echo ($p['user_date']); ?></li>
                            <li><a href="">订单详情></a></li>
                            <div class="clear"></div>
                        </ul>
                    </div>
