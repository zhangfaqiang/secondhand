...
<div class="top center">
    <div class="logo center">
        <a href="./index.html" target="_blank"><img src="../Q-image/mistore_logo.png" alt=""></a>
    </div>
</div>
    ...
    <div class="login">
        <div class="login_center">
            <div class="login_top">
                ...
                <div class="right fr">您还不是我们的会员？<a href="<?php echo U('Home/Register/index');?>" target="_self">立即注册</a></div>
                <div class="clear"></div>
            ...
            <div class="login_main center">
                ...
                <div class="username">
                    ...
                    <div class="right fl"><img onclick="refreshCaptcha()" id="captcha"></div>
                    <div class="clear"></div>
                </div>
            </div>
...
<footer>
    ...
    <div class="copyright">小米公司版权所有-京ICP备10046444-<img src="../Q-image/ghs.png" alt="">京公网安备11010802020134号-京ICP证110507号
    </div>
