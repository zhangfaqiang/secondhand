...
<div class="border_top_cart">
    ...
    <form action="<?php echo U('Home/pay/zhifu2');?>" method="post">
        <div class="container">
            <div class="checkout-box">

                <div class="checkout-box-bd">
                    <!-- 地址状态 0：默认选择；1：新增地址；2：修改地址 -->
                    <input type="hidden" name="" id="addrState" value="0">
                    <!-- 收货地址 -->
                    <div class="xm-box">
                        <div class="box-hd ">
                        ...
                        <div class="box-bd">
                            <div class="clearfix xm-address-list" id="checkoutAddrList">
                                <?php if(is_array($addressinfo)): foreach($addressinfo as $key=>$a): ?><dl class="item" >
                                        <dt>
                                            <strong class="itemConsignee"><?php echo ($a['consignee']); ?></strong>
                                            <input type="hidden" readonly=“readonly” name="id" value="<?php echo ($a['id']); ?>">
                                            <span class="itemTag tag"><?php echo ($a['miaoshu']); ?></span>
                                        </dt>
                                        <dd>
                                            <p class="tel itemTel"><?php echo ($a['phone']); ?></p>
                                            <p class="itemRegion"><?php echo ($a['addressinfo']); ?></p>
                            ...
                            <div class="xm-edit-addr-box" id="J_editAddrBox">
                                <div class="bd">
                                    ...
                                    <div class="item">
                                        ...
                                        <input type="text" name="" class="input" id="Telephone"
                                    ...
                                    <div class="item">
                                        ...
                                        <select name="" id="Provinces" class="select-1">
                                            <option>省份/自治区</option>
                                        </select>
                                        <select name="" id="Citys" class="select-2" disabled>
                                            <option>城市/地区/自治州</option>
                                        </select>
                                        <select name="" id="Countys" class="select-3" disabled>
                                            <option>区/县</option>
                                        </select>
                                        <textarea name="" class="input-area" id="Street"
                                                  placeholder="路名或街道地址，门牌号"></textarea>
                                        <p class="tip-msg tipMsg"></p>
                                    </div>
                                    <div class="item">
                                        <label>邮政编码<span>*</span></label>
                                        <input type="text" name="" id="Zipcode" class="input"
                                    ...
                                    <div class="item">
                                        ...
                                        <input type="text" name="" id="Tag" class="input"
                        ...
                        <div class="xm-box">
                            ...
                            <div class="box-bd">
                                <ul id="checkoutShipmentList" class="checkout-option-list clearfix J_optionList">
                                    <li class="item selected">
                                        <input type="radio" data-price="0" name=""
                    ...
                    <div class="xm-box">
                        ...
                        <div class="box-bd">
                            <ul class="checkout-option-list clearfix J_optionList">
                                ...
                                <li class="item "><input type="radio" name="" value="2">
                                    <p>工作日送货<span>周一至周五</span></p></li>
                                <li class="item "><input type="radio" name="" value="3">
                            ...
                            <div class="box-bd">
                                <ul class="checkout-option-list checkout-option-invoice clearfix J_optionList J_optionInvoice">
                                    ...
                                    <li class="item selected">
                                        ...
                                        <input type="radio" checked="checked" value="4" name="">
                                        <p>电子发票（非纸质）</p>
                                    </li>
                                    <li class="item ">
                                ...
                                <div class="invoice-info nvoice-info-1" id="checkoutInvoiceElectronic"
                                    ...
                                    <p>发票抬头：个人</p>
                                    <p>
                                        <span class="hide"><input type="radio" value="4" name=""
                                ...
                                <div class="invoice-info invoice-info-2" id="checkoutInvoiceDetail"
                                    ...
                                    <ul class="type clearfix J_invoiceType">
                                        ...
                                        <li class="">
                                            <input class="invoiceType" type="radio" name=""
                                                   value="2">
                                            单位
                                        </li>
                                    </ul>
                                    <div id='CheckoutInvoiceTitle' class=" hide  invoice-title">
                                        <label>单位名称：</label>
                                        <input name="" type="text" maxlength="49" value=""
                ...
                <div class="checkout-box-ft">
                        ...
                        <div class="xm-box">
                            ...
                            <div class="box-bd">
                                <dl class="checkout-goods-list">
                                    ...
                                    <?php if(is_array($goodsinfo)): foreach($goodsinfo as $key=>$g): if(is_array($g)): foreach($g as $key=>$c): ?><dd class="item clearfix">
                                                <div class="item-row">
                                                    <div class="col col-1">
                                                        <div class="g-pic">
                                                            <img src="<?php echo ($c['goods_img']); ?>" srcset="<?php echo ($c['goods_img']); ?> 2x"
                                                                 width="40" height="40"/>
                                                        </div>
                                                        <div class="g-info">
                                                            <a href="#">
                                                                <input type="hidden" name="goods_name[]"
                                                                       value="<?php echo ($c['goods_name']); ?>"> <?php echo ($c['goods_name']); ?>
                                                                <input type="hidden" name="goods_id[]"
                                                                       value="<?php echo ($c['goods_id']); ?>">
                                                            </a>
                                                        </div>
                                                    </div>

                                                    <div class="col col-2"><?php echo ($c['shop_price']); ?></div>
                                                    <div class="col col-3"><?php echo ($c['goods_sl']); ?></div>
                                                    <input type="hidden" name="goods_sl[]"
                                                           value="<?php echo ($c['goods_sl']); ?>">
                                                    <div class="col col-4"><?php echo ($c['shop_price']*$c['goods_sl']); ?>元</div>
                                                </div>
                                    ...
                                    <div class="checkout-count clearfix">
                                        ...
                                        <div class="checkout-price">
                                            <ul>
                                                ...
                                                <li>
                                                    订单总额：<span><?php echo ($shuju3); ?>元</span>
                                                </li>
                                                <li>
                                                    活动优惠：<span>-0元</span>
                                                    <script type="text/javascript">
                                            ...
                                            <p class="checkout-total">应付总额：<span><strong id="totalPrice"><input
                                                    ...
                                                    value="<?php echo ($shuju3); ?>"><?php echo ($shuju3); ?></strong>元</span>
                                            </p>
                                        </div>
                                        <!--  -->
                                    </div>
                    ...
                    <!-- 商品清单 END -->
                    <input type="hidden" id="couponType" name="">
                    <input type="hidden" id="couponValue" name="">
