...
var simpleAlert = function (opts) {
    ...
    //事件
    var dialog = {}
    var $simpleAlert = $('<div class="simpleAlert"></div>');
    var $shelter = $('<div class="simpleAlertShelter"></div>');
    var $simpleAlertBody = $('<div class="simpleAlertBody"></div>');
    var $simpleAlertBodyClose = $('<img class="simpleAlertBodyClose" src="/SecondHand/Public/popup/image/close.png" height="14" width="14"/>');
