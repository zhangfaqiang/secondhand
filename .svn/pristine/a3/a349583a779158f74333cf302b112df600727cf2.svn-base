...
<head>
    ...
    <title>用户注册</title>
    <!--<link rel="stylesheet" type="text/css" href="/SecondHand/Public/bootstrap-3.3.7/css/bootstrap.css">-->
    ...
    <!--<script type="text/javascript" src="/SecondHand/Public/bootstrap-3.3.7/js/bootstrap.min.js"></script>-->
</head>
<body>
    ...
    <div class="regist">
        <div class="regist_center">
            ...
            <div class="regist_main center">
                ...
                <button id="sendCaptcha" type="button" style="margin-left: 75px;">点击发送验证码</button>
                <div class="username">
            ...
            <div style="margin-left: 620px; margin-top: -50px;"><span>已有账号？</span><a href="<?php echo U('Home/Login/index');?>">点击返回登陆</a></div>
        </div>
    </div>
</form>
</body>
